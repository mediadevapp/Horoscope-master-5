...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        // 2.时间标签
        [self addSubview:_lastUpdateTimeLabel = [self labelWithFontSize:10]];
        
        // 3.状态标签
        [self addSubview:_statusLabel = [self labelWithFontSize:12]];
...
- (void)setFrame:(CGRect)frame
{
   frame.size.height = MJRefreshViewHeight;
    ...
    _arrowImage.frame = CGRectMake(0 , 0, 14, 23);
    // 3.箭头
