...
- (id)initWithDelegate:(id)delegate groupId:(NSString*)groupId {
    ...
    if (self) {
        ...
        [self setImage:[UIImage imageNamed:@"weixuanzhong.png"] forState:UIControlStateNormal];
        [self setImage:[UIImage imageNamed:@"xuanzhong.png"] forState:UIControlStateSelected];
