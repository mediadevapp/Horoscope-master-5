...
-(void)defaultInit{
    ...
    [_button setImage:[UIImage imageNamed:@"weixuanzhong.png"] forState:UIControlStateNormal];
    [_button setImage:[UIImage imageNamed:@"xuanzhong.png"] forState:UIControlStateSelected];
